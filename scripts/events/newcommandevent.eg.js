 ...
 * Và kiến thức về api không chính thức của facebook như api.sendMessage, api.changeNickname,... bạn có thể tìm hiểu thêm tại đây: https://github.com/ntkhang03/SiFu-FCA/blob/master/DOCS.md
 ...
 * And knowledge of unofficial facebook api such as api.sendMessage, api.changeNickname,... you can learn more at here: https://github.com/ntkhang03/SiFu-FCA/blob/master/DOCS.md
...
module.exports = {
        ...
        // onStart is a function that will be executed when has new event in group (see more at https://github.com/ntkhang03/SiFu-FCA/blob/master/DOCS.md#apilistenmqttcallback (Event Type: "event"))
        onStart: async function ({ api, usersData, threadsData, message, event, userModel, threadModel, prefix, dashBoardModel, globalModel, dashBoardData, globalData, envCommands, envEvents, envGlobal, role, getLang , commandName }) {
                ...
                // check if event is user join group, see more at https://github.com/ntkhang03/SiFu-FCA/blob/master/DOCS.md#apilistenmqttcallback
