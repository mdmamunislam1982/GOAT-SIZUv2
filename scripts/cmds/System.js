    ...
    onStart: async function ({ message }) {
        try {
            ...
            for (let i = 0; i < frameCount; i++) {
                ...
                ctx.fillText("SIZU", centerX, centerY - 15);
                ctx.fillStyle = textColor;
                ctx.font = '16px Arial';
                ctx.fillText("CEO SIFU", centerX, centerY + 22);
            ...
            return message.reply(` Could not generate the system dashboard image due to an internal error.`);
        }
    }
};