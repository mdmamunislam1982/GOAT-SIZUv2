...
const W = 490, H = 840;
const AVATAR1 = "https://i.imgur.com/ppi4ITK.png";
const FALLBACK_AVATAR = "https://i.ibb.co/rffQH2qL/l-Cc-GYFLEr4.png.jpeg"; // fallback if error
...
async function drawPage1(ctx) {
  ...
  ctx.shadowBlur = 25;
  ctx.fillText("MD SIFAT", W / 2, 295); // slightly lower
  ...
  const lines = [
    "Nickname: SIFU", "Age: 18+", "DOB: 26 July 2007",
    "Gender: Male", "Religion: Islam", "Nationality: Bangladeshi",
    "Location: Khulna, Mohammad Nogor",
  ...
  ctx.shadowBlur = 25;
  const obf = String.fromCharCode(169) + "SIFU";
