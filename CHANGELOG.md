## 📦 Version 1.5.35
### ⬆️ What's Changed
- **FCA-SiFu/index.js**: fix: fca not working
- **FCA-SiFu/src/listenMqtt.js**: fix: fca not working
### Contributors
...
## 📦 Version 1.5.32
### ⬆️ What's Changed
- **FCA-SiFu/index.js**: add new api: `handleFriendRequest`
- **FCA-SiFu/src/editMessage.js**: Update editMessage.js
- **FCA-SiFu/src/handleFriendRequest.js**: add new api: `handleFriendRequest`
...
- **FCA-SiFu/src/addExternalModule.js**: add 2 more parameters: `utils` and `log` when calling the function in `moduleObj`
...
## 📦 Version 1.5.26
### ⬆️ What's Changed
- **FCA-SiFu/src/editMessage.js**: add new api `editMessage`: edit message
- **FCA-SiFu/index.js**: add new api `editMessage`: edit message
### Contributors
...
## 📦 Version 1.5.14
### ⬆️ What's Changed
- **FCA-SiFu/src/listenMqtt.js**: fix event `log:thread-icon` not working
- **FCA-SiFu/utils.js**: fix event `log:thread-icon` not working
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
## 📦 Version 1.5.9
### ⬆️ What's Changed
- **FCA-SiFu/src/sendMessage.js**: add function `removeSpecialChar`: remove forbidden characters sent via facebook messages
...
## 📦 Version 1.5.6
### ⬆️ What's Changed
- **FCA-SiFu/index.js**: fca upadte
- **FCA-SiFu/src/getFriendsList.js**: fca upadte
- **FCA-SiFu/src/sendMessage.js**: fca upadte
- **FCA-SiFu/src/setMessageReaction.js**: fca upadte
...
## 📦 Version 1.5.5
### ⬆️ What's Changed
- **FCA-SiFu/src/listenMqtt.js**: fix `event.participantIDs` not displaying correctly in thread
...
## 📦 Version 1.5.3
### ⬆️ What's Changed
- **FCA-SiFu/src/listenMqtt.js**: fix "TypeError: Cannot read properties of undefined (reading 'get')" when listenMqtt is closed
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
- **FCA-SiFu/src/addUserToGroup.js**: Update addUserToGroup.js
- **FCA-SiFu/src/listenMqtt.js**: Update listenMqtt.js
...
- **FCA-SiFu/src/changeAvatar.js**: remove package `bluebird`
- **FCA-SiFu/src/changeGroupImage.js**: remove package `bluebird`
- **FCA-SiFu/src/sendMessage.js**: remove package `bluebird`
- **FCA-SiFu/src/uploadAttachment.js**: remove package `bluebird`
- **FCA-SiFu/utils.js**: remove package `bluebird`
...
- **FCA-SiFu/index.js**: add new api `refreshFb_dtsg`: Refreshes the fb_dtsg and jazoest values in ctx of fca
- **FCA-SiFu/src/refreshFb_dtsg.js**: add new api `refreshFb_dtsg`: Refreshes the fb_dtsg and jazoest values in ctx of fca
...
Dependencies will be reinstalled for this version.
### ⬆️ What's Changed
- **FCA-SiFu/src/getThreadList.js**: Update getThreadList.js
...
- **bot/login/login.js**: code optimization
- **FCA-SiFu/src/addUserToGroup.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **FCA-SiFu/src/changeAdminStatus.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **FCA-SiFu/src/changeThreadColor.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **FCA-SiFu/src/getThreadList.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **FCA-SiFu/src/httpPostFormData.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **FCA-SiFu/utils.js**: add `CustomError` class to FCA-SiFu - easy for debugging
- **scripts/cmds/cmd.js**: code optimization
- **scripts/cmds/eval.js**: code optimization
...
- **FCA-SiFu/src/sendMessage.js**: update callback when error occurs
...
```
- **FCA-SiFu/src/listenMqtt.js**: fix bug
...
## 📦 Version 1.4.3
### ⬆️ What's Changed
- **FCA-SiFu/utils.js**: change key `participants` to `participantIDs` in callback `event` type in mqtt
- **languages/en.lang**: languages update
- **languages/vi.lang**: languages update
- **updater.js**: Update updater.js
### Contributors
...
- **FCA-SiFu/src/listenMqtt.js**: remove mqttClient listen close message and added key ``participantIDs` to event type `message` and `message_reply`
- **FCA-SiFu/utils.js**: added key `participantIDs` to event type `message`
...
## 📦 Version 1.3.18
### ⬆️ What's Changed
- **FCA-SiFu/src/listenMqtt.js**: fix infinite loop Stop listenMqtt
...
```
- **FCA-SiFu/src/getMessage.js**: update new thread colors
- **FCA-SiFu/src/listenMqtt.js**: Update listenMqtt.js
- **FCA-SiFu/src/threadColors.js**: update new thread colors
- **languages/en.lang**: language update
- **languages/vi.lang**: language update
...
```
- **FCA-SiFu/index.js**: add function `unfriend` for fca
- **FCA-SiFu/src/unfriend.js**: add function `unfriend` for fca
- **updater.js**: Update updater.js
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
```
- **FCA-SiFu/src/listenMqtt.js**: fixes `getSeqId`
- **FCA-SiFu/utils.js**: update new function: `checkLiveCookie`
- **languages/en.lang**: language update
- **languages/vi.lang**: language update
...
### ⬆️ What's Changed
- **bot/login/login.js**: code optimization
- **FCA-SiFu/index.js**: fix duplicate values in getAppState()
- **FCA-SiFu/src/addUserToGroup.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/setPostReaction.js**: can use `i_user` (another profile in facebook account)
...
- **FCA-SiFu/src/sendMessage.js**: Update sendMessage.js
- **package-lock.json**: Update package-lock.json
...
```
- **FCA-SiFu/index.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/changeAvatar.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/changeBio.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/changeGroupImage.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/changeThreadColor.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/createNewGroup.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/getCurrentUserID.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/getFriendsList.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/getUserID.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/handleFriendRequest.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/listenMqtt.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/sendMessage.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/setMessageReaction.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/setPostReaction.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/setTitle.js**: can use `i_user` (another profile in facebook account)
- **FCA-SiFu/src/unfriend.js**: can use `i_user` (another profile in facebook account)
- **languages/en.lang**: language update
- **languages/vi.lang**: language update
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
- **FCA-SiFu/README.MD**: Create README.MD
- **FCA-SiFu/src/listenMqtt.js**: and fix error listenMqtt
- **FCA-SiFu/utils.js**: hiden log error and fix error listenMqtt
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
## 📦 Version 1.3.0
### ⬆️ What's Changed
- **FCA-SiFu/index.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/utils.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/addExternalModule.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/addUserToGroup.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeAdminStatus.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeArchivedStatus.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeAvatar.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeBio.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeBlockedStatus.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeGroupImage.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeNickname.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeThreadColor.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/changeThreadEmoji.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/createNewGroup.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/createPoll.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/deleteMessage.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/deleteThread.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/forwardAttachment.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getCurrentUserID.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getEmojiUrl.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getFriendsList.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getMessage.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getThreadHistory.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getThreadInfo.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getThreadList.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getThreadPictures.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getUserID.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/getUserInfo.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/handleFriendRequest.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/handleMessageRequest.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/httpGet.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/httpPost.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/httpPostFormData.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/listenMqtt.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/logout.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/markAsDelivered.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/markAsRead.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/markAsReadAll.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/markAsSeen.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/muteThread.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/removeUserFromGroup.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/resolvePhotoUrl.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/searchForThread.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/sendMessage.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/sendTypingIndicator.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/setMessageReaction.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/setPostReaction.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/setTitle.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/threadColors.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/unfriend.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/unsendMessage.js**: remove dependency package `FCA-SiFu-temp`
- **FCA-SiFu/src/uploadAttachment.js**: remove dependency package `FCA-SiFu-temp`
...
## 📦 Version 1.2.20
### ⬆️ What's Changed
- **package.json**: update package `FCA-SiFu-temporary`
- **package-lock.json**: update package `FCA-SiFu-temporary`
- **bot/login/login.js**: update package `FCA-SiFu-temporary`
### 🗑️ Files Deleted
- **FCA-SiFu**: 
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
## 📦 Version 1.2.19
### ⬆️ What's Changed
- **FCA-SiFu/src/addExternalModule.js**: 
- **FCA-SiFu/src/addUserToGroup.js**: 
- **FCA-SiFu/src/changeAdminStatus.js**: 
- **FCA-SiFu/src/changeArchivedStatus.js**: 
- **FCA-SiFu/src/changeAvatar.js**: 
- **FCA-SiFu/src/changeBio.js**: 
- **FCA-SiFu/src/changeBlockedStatus.js**: 
- **FCA-SiFu/src/changeGroupImage.js**: 
- **FCA-SiFu/src/changeNickname.js**: 
- **FCA-SiFu/src/changeThreadColor.js**: 
- **FCA-SiFu/src/changeThreadEmoji.js**: 
- **FCA-SiFu/src/createNewGroup.js**: 
- **FCA-SiFu/src/createPoll.js**: 
- **FCA-SiFu/src/deleteMessage.js**: 
- **FCA-SiFu/src/deleteThread.js**: 
- **FCA-SiFu/src/forwardAttachment.js**: 
- **FCA-SiFu/src/getCurrentUserID.js**: 
- **FCA-SiFu/src/getEmojiUrl.js**: 
- **FCA-SiFu/src/getFriendsList.js**: 
- **FCA-SiFu/src/getMessage.js**: 
- **FCA-SiFu/src/getThreadHistory.js**: 
- **FCA-SiFu/src/getThreadInfo.js**: 
- **FCA-SiFu/src/getThreadList.js**: 
- **FCA-SiFu/src/getThreadPictures.js**: 
- **FCA-SiFu/src/getUserID.js**: 
- **FCA-SiFu/src/getUserInfo.js**: 
- **FCA-SiFu/src/handleFriendRequest.js**: 
- **FCA-SiFu/src/handleMessageRequest.js**: 
- **FCA-SiFu/src/httpGet.js**: 
- **FCA-SiFu/src/httpPost.js**: 
- **FCA-SiFu/src/httpPostFormData.js**: 
- **FCA-SiFu/src/listenMqtt.js**: 
- **FCA-SiFu/src/logout.js**: 
- **FCA-SiFu/src/markAsDelivered.js**: 
- **FCA-SiFu/src/markAsRead.js**: 
- **FCA-SiFu/src/markAsReadAll.js**: 
- **FCA-SiFu/src/markAsSeen.js**: 
- **FCA-SiFu/src/muteThread.js**: 
- **FCA-SiFu/src/removeUserFromGroup.js**: 
- **FCA-SiFu/src/resolvePhotoUrl.js**: 
- **FCA-SiFu/src/searchForThread.js**: 
- **FCA-SiFu/src/sendMessage.js**: 
- **FCA-SiFu/src/sendTypingIndicator.js**: 
- **FCA-SiFu/src/setMessageReaction.js**: 
- **FCA-SiFu/src/setPostReaction.js**: 
- **FCA-SiFu/src/setTitle.js**: 
- **FCA-SiFu/src/test.js**: 
- **FCA-SiFu/src/threadColors.js**: 
- **FCA-SiFu/src/unfriend.js**: 
- **FCA-SiFu/src/unsendMessage.js**: 
- **FCA-SiFu/index.js**: 
- **FCA-SiFu/utils.js**: 
- **bot/login/login.js**: replace package `FCA-SiFu`
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
## 📦 Version 1.2.18
### ⬆️ What's Changed
- **package.json**: package `FCA-SiFu` no longer exists
- **package-lock.json**: package `FCA-SiFu` no longer exists
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
## 📦 Version 1.2.17
### ⬆️ What's Changed
- **package.json**: change package `FCA-SiFu` to github repo
### Contributors
- <div style="display: flex; align-items: center;"><a href="https://github.com/ntkhang03">ntkhang03&nbsp;&nbsp;</a> <img src="https://github.com/ntkhang03.png" width="20" height="20" style="border-radius:50%; margin-top: px;" alt="ntkhang03"></div>
...
- **package-lock.json**: update package `FCA-SiFu` version 10.4.14
- **package.json**: update package `FCA-SiFu` version 10.4.14
