...
const login = defaultRequire(`${process.cwd()}/FCA-SiFu`);
...
const author = ("Modified by SiFu with ♡"); 
const srcUrl = ("Source code: https://github.com/Ewr-sifu/Goat-Sizu");
const fakeRelease = ("🎀🍓 thanks for using Sizu bby");
